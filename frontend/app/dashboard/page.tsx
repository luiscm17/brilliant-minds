        ...
        >
                ...
                <div className="relative z-10 grid gap-7 xl:grid-cols-[1.1fr_0.9fr] xl:items-end">
                    ...
                    <div className="rounded-[28px] bg-[rgba(255,255,255,0.78)] p-5">
                        ...
                        <p className="mt-3 text-sm leading-7 text-slate-600">
                            El sistema ya esta listo para procesar documentos, simplificar texto y
                            responder desde el chat con el tono que configuraste.
                        </p>
            ...
            <div className="grid gap-5 xl:grid-cols-[0.9fr_1.1fr]">
                ...
                >
                    ...
                    <h2 className="mt-5 text-4xl font-semibold text-slate-800">Sube el material</h2>
                    <p className="muted-copy mt-3 max-w-lg text-base leading-8">
                        Carga un PDF o Word para preparar el contexto. Mientras mas denso sea el
                        documento, mas evidente sera la mejora en la demo.
                    </p>
            ...
            >
                <div className="studio-panel p-5 md:p-6">
                    ...
                    <p className="muted-copy mt-4 max-w-2xl text-sm leading-7">
                        Estas prioridades ayudan a que la demo se vea coherente con la condicion
                        seleccionada y con el tipo de apoyo cognitivo que espera el usuario.
                    </p>
                </div>
                <div className="studio-panel p-5 md:p-6">
                    <p className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-500">
                    ...
                    <p className="muted-copy mt-3 text-sm leading-7">
                        Un archivo denso hace que la mejora se vea con mas claridad en el chat y en
                        el comparador antes vs despues.
                    </p>
