...
export default function Documents() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            setError("No fue posible subir el documento. Revisa la conexion o intenta de nuevo.");
        } finally {
            setUploading(false);
        }
    };
            ...
            <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
                ...
                >
                    ...
                    <p className="muted-copy mt-5 max-w-xl text-base leading-7">
                        Sube un PDF o Word y deja listo el material para demostrar como la lectura
                        mejora cuando el texto tiene contexto real.
                    </p>
                        ...
                        <div className="mt-4 space-y-3">
                            {loadingDocuments ? (
                                ...
                                <p className="text-sm leading-6 text-slate-500">
                                    Aun no hay documentos. Sube uno largo o denso para que el cambio
                                    se note mejor en la demo.
                                </p>
                            ) : (
                ...
                >
                    ...
                    <div className="mt-8 rounded-[24px] border border-dashed border-[rgba(13,122,116,0.24)] bg-[rgba(213,235,225,0.26)] p-5">
                        ...
                        <p className="mt-2 text-sm leading-6 text-slate-600">
                            Si vas a hacer una demo, usa un documento largo, tecnico o con muchas
                            condiciones para que el cambio sea mas evidente.
                        </p>
